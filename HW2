...
| Код      | Сервис               | Главная ответственность                                                                 | Собственная БД   |
| -------- | -------------------- | --------------------------------------------------------------------------------------- | ---------------- |
...
| 4 | **STUD/ATTN/ASGN** → **RPT**    | *async*        | Kafka topic «events.\*»  | Генерация отчётов не блокирует запись, выдерживает всплески; гарантированная доставка fileciteturn0file0 |
...
6. **External Integration** периодически обменивается данными с другими гос‑системами.
